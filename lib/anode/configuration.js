...
var Configuration = exports.Configuration = function () {
  ...
  var log = self.createActor().withBehavior( function () {
  ...
  var warn = self.createActor().withBehavior( function () {
